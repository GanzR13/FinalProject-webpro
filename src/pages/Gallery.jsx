			...
			<div className="m-auto items-center">
				<div className="absolute top-[20%] w-full md:-[50%] h-full flex flex-col text-white p-4 items-center">
					...
					<p className="text-xl py-4 italic">
						Collections of Stunning View on the Island of Bujang
					</p>
				</div>
			</div>
			<div className="max-w-6xl m-auto w-full md:flex mt-[-100px]">
				<div className="relative p-4">
					<h3 className="absolute z-10 top-[50%] translate-x-[50%] translate-y-[50%] text-white text-2xl font-bold ">
						Resort
					</h3>
					<img
						className="w-full h-full object-cover relative border-4 border-white shadow-lg rounded-sm"
